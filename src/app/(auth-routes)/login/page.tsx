...
function Login() {
  ...
  async function enviaDados(data: Inputs) {
    ...
    if (response.ok && dados.token) {
      ...
      mudaLogin({ cod: dados.empresa.cod, nome: dados.empresa.nome, logotipo: dados.empresa.logotipo });

      toast.success("Login realizado com sucesso");
      router.push("/");
    } else {
      toast.error(dados.msg || "Erro! Login ou senha incorreta.");
    }
  }
        ...
        <div className="max-w-lg w-full p-10 bg-gray-100 rounded-lg shadow-xl">
          ...
          <form onSubmit={handleSubmit(enviaDados)}>
            ...
            <div className="flex justify-center mt-6">
              <button
                type="submit"
                className="w-3/4 py-3 bg-orange-600 text-white text-lg font-semibold rounded-full hover:bg-orange-700 transition duration-300"
              >
                Entrar
              </button>
            </div>
